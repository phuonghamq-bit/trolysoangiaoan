...
<div class="main-header">
    ...
    <p>Tác giả: Đỗ Thị Thu Hà - Trường Tiểu học Minh Quang - ĐT: 0386 897 991</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Đỗ Thị Thu Hà - Trường Tiểu học Minh Quang - ĐT: 0386 897 991</div>", unsafe_allow_html=True)
